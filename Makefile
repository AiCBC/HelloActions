#############################################################################
# Makefile for building: bin/release/HelloActions-Qt
# Generated by qmake (3.1) (Qt 5.15.15)
# Project:  HelloActions-Qt.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile HelloActions-Qt.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = HelloActions-Qt1.0.0
DISTDIR = /workspace/.tmp/HelloActions-Qt1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		HelloActions-Qt.pro  src/main.cpp
QMAKE_TARGET  = HelloActions-Qt
DESTDIR       = bin/release/
TARGET        = bin/release/HelloActions-Qt


first: all
####### Build rules

bin/release/HelloActions-Qt:  $(OBJECTS)  
	@test -d bin/release/ || mkdir -p bin/release/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: HelloActions-Qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		HelloActions-Qt.pro \
		src/qml.qrc
	$(QMAKE) -o Makefile HelloActions-Qt.pro
...
all: Makefile bin/release/HelloActions-Qt
...
qrc_qml.cpp: src/qml.qrc \
		/usr/lib/qt5/bin/rcc \
		src/main.qml
	/usr/lib/qt5/bin/rcc -name qml src/qml.qrc -o qrc_qml.cpp
